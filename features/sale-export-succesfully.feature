Feature: Sales Export Successfully
  ...
  Scenario: The Sales Manager creates a new S Contract - Export successfully
    Given I visit 'http://203.162.76.14:8080/web/login' page
      ...
      And I press key "DELETE"
      And I press key "DELETE"
      When I fill text on customer name with "CuongPM"

      When I fill in id "oe-field-input-6" with "Nestrade"
      Then I should see "Save" within 3 second
      # And I click on text "ui-id-3" "[CUS-111] Nestrade"
      And I press key "ARROW_DOWN"
      Then I should see "Save" within 2 second
      And I press key "ENTER"

      Then I should see "Save" within 5 second
      # And I press "Cancel"
      ...
      # Then I should see "Save" within 10 second
      ...
      # And I press key "ENTER"
      And I press "Save"
      # Then I should see "Save" within 12 second
